...
|---|------------------------------------------|-------------------------------------------------------------------|-------------------------|-------------------:|-------------------------------------------------------------------------------------|
| 1 | Borrowing Books - Faculty                | https://library.georgetown.edu/policies/borrowing/materials/books | 2026-09-19 / not-stated |                704 | `audience=faculty`, `department=library`, `category=borrowing`, `language=en`       |
| 2 | Borrowing Books - Undergraduate Students | https://library.georgetown.edu/policies/borrowing/materials/books | 2026-09-19 / not-stated |                478 | `audience=student`, `department=library`, `category=borrowing`, `language=en`       |
| 3 | Borrowing Media                          | https://library.georgetown.edu/policies/borrowing/materials/media | 2026-09-19 / not-stated |                941 | `audience=all`, `department=library`, `category=borrowing-media`, `language=en`     |
| 4 | Course Reserves Information for Faculty  | https://library.georgetown.edu/course-reserves/faculty            | 2026-09-19 / not-stated |               4389 | `audience=faculty`, `department=library`, `category=course-reserves`, `language=en` |
| 5 | Course Reserves Information for Students | https://library.georgetown.edu/course-reserves/students           | 2026-09-19 / not-stated |               1802 | `audience=student`, `department=library`, `category=course-reserves`, `language=en` |
| 6 | Equipment Loans                          | https://library.georgetown.edu/equipment                          | 2026-09-19 / not-stated |               2123 | `audience=all`, `department=library`, `category=equipment`, `language=en`           |
| 7 | Interlibrary and Consortium Loans        | https://library.georgetown.edu/loans                              | 2026-09-19 / not-stated |               3242 | `audience=all`, `department=library`, `category=interlibrary-loan`, `language=en`   |
| 8 | Library Use Policies                     | https://library.georgetown.edu/policies/library-use               | 2026-09-19 / not-stated |               2360 | `audience=all`, `department=library`, `category=library-use`, `language=en`         |
...
|---------------------------------|----------------------------------|---------------:|------------------:|
| `course-reserves-student`       | FixedSizeChunker (`fixed_size`)  |              3 |             634.0 |
| `course-reserves-student`       | SentenceChunker (`by_sentences`) |              7 |             255.6 |
| `course-reserves-student`       | RecursiveChunker (`recursive`)   |              3 |             599.3 |
| `equipment-loans`               | FixedSizeChunker (`fixed_size`)  |              4 |             568.2 |
| `equipment-loans`               | SentenceChunker (`by_sentences`) |              8 |             262.8 |
| `equipment-loans`               | RecursiveChunker (`recursive`)   |              4 |             529.2 |
| `interlibrary-consortium-loans` | FixedSizeChunker (`fixed_size`)  |              5 |             688.4 |
| `interlibrary-consortium-loans` | SentenceChunker (`by_sentences`) |             10 |             322.0 |
| `interlibrary-consortium-loans` | RecursiveChunker (`recursive`)   |              6 |             538.7 |
...
|---|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| 1 | How long can I borrow books? *(filter: `{"audience":"student"}`)*              | Đối với undergraduate student: số sách không giới hạn và thời hạn mượn là 6 tuần.                                                                                     | `borrowing-books-undergraduate` - `## Georgetown Users`                                       |
