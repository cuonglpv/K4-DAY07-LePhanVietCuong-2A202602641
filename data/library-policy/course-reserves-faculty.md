---
doc_id: "course-reserves-faculty"
title: "Course Reserves Information for Faculty"
source_url: "https://library.georgetown.edu/course-reserves/faculty"
...
Faculty members can make requests for physical books to be placed on reserve by using this Book Reserve Form. More information on placing books on reserve can be found on the form.

These books are housed in Access Services and can be borrowed by students whenever the Service Desk is open. Reserves can be held at the circulation desks of Lauinger, Blommer, and/or Capitol Campus.
...
Personal copies -- if you would like us to place your own personal copy of something on reserve, please email us at reserves@georgetown.edu.

Faculty may request books not owned by Georgetown University Library on the Book Reserve Form and we will attempt to purchase. When purchasing eBooks for reserve, we will purchase the maximum number of user electronic books whenever possible. We will provide the faculty member with a permalink to the eBooks page. If no eBook is available we will try to purchase a physical copy of the title.

Comments or questions? Please email reserves@georgetown.edu
...
There is no limit to the number of e-reserves a faculty member may request. An e-reserve is a single title of a book chapter, a journal article, or professors' notes, syllabi, or handouts. Due to copyright restrictions, consumable materials such as lab manuals and workbooks will not be scanned for e-reserves. If the library does not have the desired book or article, we will attempt to purchase it. We cannot scan more than approximately 20% of a book due to Copyright. Read more about restrictions on e-reserves in our Copyright Policies.
